...
const TabColor = (colors) => `
  ...
  .ant-tabs-nav .ant-tabs-tab.ant-tabs-tab-active {
    ...
    background : ${colors !== 'default' && colors};
		.ant-tabs-tab-btn{
			color: ${colors !== 'default' && colors !== '#ffffff' && colors !== '#fff' && colors !== 'white' ? '#ffffff' : '#27325A'};
			svg{
				fill: ${colors !== 'default' && colors !== '#ffffff' && colors !== '#fff' && colors !== 'white' ? '#ffffff' : '#27325A'};
			}
		}
  }
  .ant-tabs-tab.ant-tabs-tab-active{
    color : ${
      colors !== 'default' && colors !== '#ffffff' && colors !== '#fff' && colors !== 'white' ? '#ffffff' : '#27325A'
    };
  }
  .ant-tabs-ink-bar {
